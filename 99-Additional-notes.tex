...
\begin{defn}
  Let $P$ be a partially ordered set. An element $c \in P$ is called \textbf{compact} (or \textbf{finite}) if, for every directed subset $D \subseteq P$ that has a supremum $\sup D$ in $P$, the following condition holds:
