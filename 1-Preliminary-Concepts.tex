...
\begin{lem}
    ...
    \[
        \fun{transport}^P(e)\colon P(x)\to P(y).
    \]
...
\begin{exr}
    ...
    \[
        \prod_{x,y:\,A}\;
            \prod_{p:\,x\eq Ay}\;
            \prod_{b:\,B}\fun{transport}^P(p,b)\eq Bb.
    \]
\end{exr}
...
\begin{solution}
    ...
    Consider the motive
    \[
    D(x,y,p)\defeq\prod_{b:\,B}\fun{transport}^P(p,b)\eq B b.
    \]
...
\begin{solution}
    ...
    \[
        \fun{transport}^P\colon\prod_{y:\,A}\;\prod_{p:\,x\eq Ay}P(x)\to P(y).
    \]
