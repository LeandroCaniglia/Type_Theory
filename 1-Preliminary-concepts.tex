...
\begin{lpar}{Right unit law.}\label{lpar:right-unit-law}
    ...
    \begin{lem}
        ...
        \[
            \fun{unit}_r(p)\colon p\cdot\fun{refl}_y\eq Ap.
        \]
    \end{lem}
...
\begin{lpar}{Path induction equivalence.}
    ...
    For the converse, we will need the following:
    
    \begin{quote}\small
        Let  $P\colon A \to \univ$ be a family of types. For any path  $e\colon x \eq A y$, there is a function
        \[
            \fun{subst}(e)\colon P(x)\to P(y),
        \]
        defined by path induction on  $e$. For the base case  $e\equiv\fun{refl}_x$, we take the identity function  $\lambda z.\,z$.
    \end{quote}
    
    \medskip
    
    Fix  $a\colon A$ and suppose we are given
    \[
