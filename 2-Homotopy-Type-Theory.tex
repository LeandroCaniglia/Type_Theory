...
\begin{defn}
    ...
    \begin{enumerate}[a),font=\upshape]
        ...
        \[
            p\cdot\beta\colon(p\ct r)\eq{x\eq Az}(p\ct s)
        \]
        by path induction on $\beta$: if $r\equiv s$ and $\beta\equiv\fun{refl}_r$, then $p\cdot\fun{refl}_r\defeq\fun{refl}_{p\ct r}$.
        ...
        \[
            \alpha\cdot r\colon(p\ct r)\eq{x\eq Az}(q\ct r)
        \]
        by induction on $\alpha$: if $q\equiv p$ and $\alpha\equiv\fun{refl}_p$, then $\fun{refl}_p\cdot r\defeq\fun{refl}_{p\ct r}$.
    \end{enumerate}
\end{defn}
...
\begin{proof}
    ...
    \begin{description}[font=\normalfont\scshape]
        ...
        \item[Step 3.] Induction on $\beta$ and $\delta$. Applying the same logic to the right column, we assume $\beta$ and $\delta$ are $\fun{refl}_r$, which forces $s \equiv r$ and $v \equiv r$.
...
\begin{description}[font=\normalfont\scshape]
    ...
    \begin{rem}
        The Univalence Axiom asserts that $\fun{idtoeqv}$ is an equivalence. In particular, $(A\eq\univ B)\simeq(A\simeq B)$. Moreover, it allows us to stablish the following rules
        \begin{enumerate}[-]
            ...
            \]
            \item the propositionally computation rule: for $f\colon A\simeq B$ and $x\colon A$,
            \[
                \fun{ittoeqv}(\fun{ua}(f),x)\eq Bf(x),
            \]
