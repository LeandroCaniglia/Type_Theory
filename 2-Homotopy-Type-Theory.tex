...
\begin{proof}
    The second equality is a direct consequence of the definition in Theorem~\ref{thm:idtoeqv-def} when $\fun{idtoeqv}\colon B(x)\simeq B(y)$ is identified with the map $B(x)\to B(y)$, as established in Notation~\ref{ntn:abuse-equivalence}.
